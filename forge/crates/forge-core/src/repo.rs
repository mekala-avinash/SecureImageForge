...
impl BuildRepo {
    ...
    pub async fn insert_for_project(&self, record: &BuildRecord, project_id: &str) -> Result<()> {
    ...
    pub async fn list_project(&self, project_id: &str, limit: i64) -> Result<Vec<BuildSummary>> {
        let rows = sqlx::query(
    ...
    pub async fn get_summary(&self, build_id: Uuid) -> Result<Option<BuildSummary>> {
        self.get_summary_in_project("default-project", build_id)
            .await
    }

    pub async fn get_summary_in_project(
        &self,
        project_id: &str,
        build_id: Uuid,
    ...
    pub async fn get_record(&self, build_id: Uuid) -> Result<Option<BuildRecord>> {
        self.get_record_in_project("default-project", build_id)
            .await
    }

    pub async fn get_record_in_project(
        &self,
        project_id: &str,
        build_id: Uuid,
    ...
    pub async fn drift_targets(&self, limit: i64) -> Result<Vec<(Uuid, String)>> {
        let rows = sqlx::query(
    ...
    pub async fn get_project_id(&self, build_id: Uuid) -> Result<Option<String>> {
